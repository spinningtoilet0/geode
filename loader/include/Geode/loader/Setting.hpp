...
namespace geode {
    ...
    public:
        ...
        virtual bool load(json11::Json const& json) = 0;
        virtual bool save(json11::Json& json) const = 0;
    ...
    public:
        ...
        bool load(json11::Json const& json) override;
        bool save(json11::Json& json) const;
