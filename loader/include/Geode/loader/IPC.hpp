...
namespace geode {
    ...
    public:
        ...
        std::unique_ptr<json11::Json> messageData;
    ...
    public:
        using Callback = json11::Json(IPCEvent*);
    ...
    std::monostate listenForIPC(std::string const& messageID, json11::Json(*callback)(IPCEvent*));
}
